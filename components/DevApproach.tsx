...
const DevApproach = (props: Props) => {
    return (
        <div className="bg-blue-200 rounded-3xl p-8 md:p-12 lg:p-16 text-center mx-5 md:mx-10 mb-10">
          ...
          <div className="flex flex-col md:flex-row md:items-start md:justify-between">
            ...
            <div className="md:w-1/2 md:pl-6">
              ...
              <p className="text-lg mb-6">
                We aim to deliver your designs within a few business days, with an average turnaround time from Monday to Friday.
              </p>
